...
var teacherRouter = require('./routes/admin/teacher');

var classRouter = require('./routes/adminTeacher/classname');
var getClassRouter = require('./routes/studentUser/getClass');

var adminPanelRouter = require('./routes/admin/admin-panel');
var adminDashboardRouter = require('./routes/admin/admin-dashboard');
var adminTeacherListRouter = require('./routes/admin/teacherList');
var adminStudentListRouter = require('./routes/admin/student/studentList');
var studentUserRouter = require('./routes/admin/studentUser');
